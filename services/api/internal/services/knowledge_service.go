...
// Viewer is the officer asking, with the rank level every query is bounded by.
type Viewer struct {
	ID    uuid.UUID
	Level int
}
...
func (s *KnowledgeService) Search(ctx context.Context, v Viewer, f repository.KnowledgeFilter) ([]models.KnowledgeSearchHit, int64, error) {
	f.ViewerLevel = v.Level
	return s.repo.Search(ctx, f)
}

func (s *KnowledgeService) Stats(ctx context.Context, v Viewer) (*models.KnowledgeStats, error) {
	return s.repo.Stats(ctx, v.Level)
}

// Get returns a visible document. Opening anything above PUBLIC is audited.
func (s *KnowledgeService) Get(ctx context.Context, v Viewer, id uuid.UUID) (*models.KnowledgeDocument, error) {
...
func (s *KnowledgeService) Open(ctx context.Context, v Viewer, id uuid.UUID) (io.ReadCloser, *models.KnowledgeDocument, error) {
	d, err := s.repo.Get(ctx, id, v.Level)
	if err != nil {
		return nil, nil, err
	}
...
func (s *KnowledgeService) validate(v Viewer, in *models.KnowledgeDocumentInput) (time.Time, error) {
...
func (s *KnowledgeService) storeUpload(ctx context.Context, v Viewer, in models.KnowledgeDocumentInput, issued time.Time,
...
func (s *KnowledgeService) Upload(ctx context.Context, v Viewer, in models.KnowledgeDocumentInput,
...
func (s *KnowledgeService) Supersede(ctx context.Context, v Viewer, oldID uuid.UUID, in models.KnowledgeDocumentInput,
	filename, contentType string, file io.Reader) (*models.KnowledgeDocument, error) {
...
func (s *KnowledgeService) Withdraw(ctx context.Context, v Viewer, id uuid.UUID, reason string) (*models.KnowledgeDocument, error) {
...
func (s *KnowledgeService) SetClassification(ctx context.Context, v Viewer, id uuid.UUID, req models.KnowledgeClassificationRequest) (*models.KnowledgeDocument, error) {
...
func (s *KnowledgeService) Checklists(ctx context.Context, v Viewer, documentID *uuid.UUID) ([]models.KnowledgeChecklist, error) {
	return s.repo.ListChecklists(ctx, v.Level, documentID)
}

func (s *KnowledgeService) Checklist(ctx context.Context, v Viewer, id uuid.UUID) (*models.KnowledgeChecklist, error) {
	return s.repo.GetChecklist(ctx, id, v.Level)
}

func (s *KnowledgeService) CreateChecklist(ctx context.Context, v Viewer, in models.KnowledgeChecklistInput) (*models.KnowledgeChecklist, error) {
...
func (s *KnowledgeService) Runs(ctx context.Context, v Viewer, checklistID uuid.UUID) ([]models.KnowledgeChecklistRun, error) {
...
func (s *KnowledgeService) StartRun(ctx context.Context, v Viewer, checklistID uuid.UUID, in models.KnowledgeRunInput) (*models.KnowledgeChecklistRun, error) {
...
func (s *KnowledgeService) Tick(ctx context.Context, v Viewer, runID uuid.UUID, in models.KnowledgeTickInput) (*models.KnowledgeChecklistRun, error) {
...
func (s *KnowledgeService) Run(ctx context.Context, v Viewer, id uuid.UUID) (*models.KnowledgeChecklistRun, error) {
