...
func CORS() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.Header("Access-Control-Expose-Headers", "Content-Length, Content-Type, Content-Disposition, X-Evidence-SHA256, X-Evidence-Number, X-Document-SHA256, X-Document-Number")
